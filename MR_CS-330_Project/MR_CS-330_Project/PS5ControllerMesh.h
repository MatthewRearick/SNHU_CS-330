...
/**
 * Class representing a PS5ControllerMesh object with transformations.
 */
class PS5ControllerMesh : public Mesh {
public:
    // ################
    // # Constructors #
    // ################
     ...
     */
    PS5ControllerMesh(VertexMode vertexMode, UnitOfMeasure unitOfMeasure, glm::vec3 scale = DEFAULT_SCALE_VEC3, glm::vec3 rotationDegrees = DEFAULT_ROTATION_DEGREES_VEC3,
     ...
     * @param sectorCount The number of sectors around curved controller sections (greater = more triangles and detail).
     */
    PS5ControllerMesh(VertexMode vertexMode, UnitOfMeasure unitOfMeasure, GLuint shaderProgramId = -1, int sectorCount = 100);
