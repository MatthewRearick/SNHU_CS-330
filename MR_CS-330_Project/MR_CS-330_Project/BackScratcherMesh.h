...
/**
 * Class representing a BackScratcherMesh object with transformations.
 */
class BackScratcherMesh : public Mesh {
public:
    // ################
    // # Constructors #
    // ################
     ...
     */
    BackScratcherMesh(VertexMode vertexMode, UnitOfMeasure unitOfMeasure, glm::vec3 scale = DEFAULT_SCALE_VEC3, glm::vec3 rotationDegrees = DEFAULT_ROTATION_DEGREES_VEC3,
     ...
     * @param sectorCount The number of sectors around curved controller sections (greater = more triangles and detail).
     */
    BackScratcherMesh(VertexMode vertexMode, UnitOfMeasure unitOfMeasure, GLuint shaderProgramId = -1, int sectorCount = 100);
